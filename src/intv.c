...
static size_t u32le_bitused (size_t bitused, const u32 *v)
{
	if (! (0 < bitused))
		return 0;
size_t i, msb;
...
size_t intv_store_u8be (const struct intv *this__, void *dst_)
{
const intv_s *this_;
...
bool intv_load_u8be (struct intv *this__, const void *src_, size_t cb)
{
intv_s *this_;
	this_ = (intv_s *)this__;
const u8 *src;
...
int u8be_cmp (const void *lhs_u8be, size_t lhs_cb, const void *rhs_u8be, size_t rhs_cb)
{
const u8 *lhs, *rhs;
	lhs = (const u8 *)lhs_u8be;
	rhs = (const u8 *)rhs_u8be;
size_t lhs_bitused, rhs_bitused;
size_t i, msb;
...
bool vmodpow (struct intv *r_, struct intv *g_, const struct intv *a_, const struct intv *p_, void (*bits_fn)(void *bits_arg), void *bits_arg, size_t bits_span)
{
intv_s *r, *g;
...
bool vmodpow32 (struct intv *r, u32 g_, const struct intv *a, const struct intv *p, void (*bits_fn)(void *bits_arg), void *bits_arg, size_t bits_span)
{
	if (g_ < 2)
		return false;
struct intv *g;
